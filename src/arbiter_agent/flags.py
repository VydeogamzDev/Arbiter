...
_FLAGS = [
    ...
    Flag("reasoning_advisor", True, "M9", "Reasoning scheduler recommendations (advisory)"),
    Flag("retrieval_reranker", True, "M9", "Context retrieval: pins, fused ranking, adaptive top-k, miss detection"),
    Flag("diff_risk", True, "M9", "Diff risk and review scheduling (shadow)"),
    Flag("tool_gateway", False, "M10", "Stable tool gateway"),
    Flag("host_api", True, "M9", "Host Advisory API v0 (shadow)"),
